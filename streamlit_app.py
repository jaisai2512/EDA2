...
Questions: generate goal that explore potential relationships between the variable described and other fields in the dataset.your goals should be questioning the relationship between variable, no univariate analysis
