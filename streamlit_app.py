...
"""
    ...
    Rule:\ni)When generating questions, first consider the meaning and significance of the variable. Does this variable have the potential to yield valuable insights through univariate analysis, such as distribution patterns, central tendency, and spread?\n{FORMAT_INSTRUCTIONS}"""
