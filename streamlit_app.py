...
Questions: generate goal that explore potential relationships between the variable described and other fields in the dataset. Ensure that each question assesses whether one variable has an influence or correlation with another variable.Ensure that the questions are insightful and avoid univariate analysis.
