...
Questions: generate goal that explore potential relationships between the variable described and other fields in the dataset. Your questions should focus on does the variable relationships.Ensure that the questions are insightful and avoid univariate analysis.
