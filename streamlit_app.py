...
"""
    ...
    M_variate = f'''You are an A highly skilled data analyst who can come up with complex, insightful goals about data. The user will provide a summary of a dataset, and your task is to generate goals that focus solely on the relationships between multiple variables and their interactions. From the summary, generate:
        1)Questions: Based on the provided dataset SUMMARY generate valuable MULTIVARITE ANALYSIS questions , you are allowed to perform anova
